...
public class MultipleSelectionSpinner extends AppCompatSpinner implements
  ...
  public void onClick(DialogInterface dialog, int which, boolean isChecked) {
    if (mSelection != null && which < mSelection.length) {
      ...
      if (buildSelectedItemString().length() > 0) {
        ...
        //simple_adapter.add("SELECCIONE EMPACADORA");
      }
    } else {
  ...
  public boolean performClick() {
    ...
    builder.setTitle("SELECCIONE PRODUCTOS");
    ...
    builder.setNegativeButton("ACEPASDSADTAR", new DialogInterface.OnClickListener() {
      @Override
      public void onClick(DialogInterface arg0, int arg1) {
